...
class NotificationsTableToolbar extends React.Component {
  render() {
    return (
      <Toolbar
...
NotificationsTableToolbar.propTypes = {
  classes: PropTypes.object.isRequired,
  numSelected: PropTypes.number.isRequired,
};

export default withStyles(toolbarStyles)(NotificationsTableToolbar);
