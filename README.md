...
This will create a file called `openmrs-owa-notification.zip` file in the `dist` directory,
...
This will build and deploy the app to the `/home/isurangaperera/openmrs/platform/owa`
